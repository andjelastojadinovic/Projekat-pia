...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO umetnici (ime, prezime, korisnicko_ime, lozinka, email) VALUES ('$ime', '$prezime', '$korisnickoIme', '$hashed_lozinka', '$email')";
    
    if (mysqli_query($conn, $query)) {
        header("Location: pocetna_umetnik.html");
    } else {
